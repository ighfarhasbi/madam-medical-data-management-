...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("link", name="image rf_m_ibuhamil P. BALITA").click()
    page.get_by_role("cell", name="Tgl Monitoring Terakhir: 2024-06-25 Tgl Follow Up : 2024-07-25 N BY BT EPPGBM", exact=True).get_by_role("button").nth(2).click()
    ...
    page.get_by_role("list").filter(has_text=re.compile(r"^Pneumoni$")).click()
    ...
    page.get_by_role("textbox", name="Keterangan Bayi Sakit").fill("sakit kepala")
    ...
    page.get_by_role("spinbutton", name="BB").click()
    page.get_by_role("spinbutton", name="BB").fill("2000")
    page.get_by_role("spinbutton", name="PB/TB").click()
    page.get_by_role("spinbutton", name="PB/TB").fill("10")
    page.get_by_role("spinbutton", name="Lingkar Kepala").click()
    page.get_by_role("spinbutton", name="Lingkar Kepala").fill("20")
    page.get_by_label("Status Gizi (BB/PB atau BB/TB)").select_option("Gizi buruk")
    page.get_by_label("Status Gizi (PB/U atau TB/U)").select_option("Pendek")
    page.get_by_text("Status Gizi (BB/U) Sangat").click()
    page.get_by_label("Status Gizi (BB/U)").select_option("Normal")
    page.get_by_label("Status Gizi (IMT/U)").select_option("Berisiko gizi lebih")
    page.get_by_role("spinbutton", name="Lila").click()
    page.get_by_role("spinbutton", name="Lila").fill("14")
    page.get_by_label("Kategori LilA").select_option("Gizi Kurang")
    page.get_by_label("Kenaikan Berat Badan dari").select_option("Naik")
    page.get_by_role("radio", name="Tes HIV Ya").check()
    page.get_by_role("textbox", name="Tanggal Screening TB dan HIV").fill("2025-05-14")
    page.locator("a").filter(has_text="Bukan Terduga TBC").click()
    page.locator("#hasil_screening_tbhiv_chosen").get_by_text("HIV", exact=True).click()
    page.locator("a").filter(has_text="Belum Mendapatkan").click()
    page.locator("#pengobatan_tbhiv_chosen").get_by_text("OAT").click()
    page.get_by_label("Pemeriksaan Darah", exact=True).select_option("Trombosit")
    page.get_by_label("Hasil pemeriksaan darah", exact=True).select_option("reaktif")
    ...
    page.get_by_role("textbox", name="Hasil pemeriksaan TB").fill("20")
    page.get_by_role("textbox", name="Hasil Pemeriksaan Lab Lainnya").click()
    page.get_by_role("textbox", name="Hasil Pemeriksaan Lab Lainnya").fill("lab lainnya")
    page.get_by_role("textbox", name="Pemeriksaan Penunjang Lainnya", exact=True).click()
    page.get_by_role("textbox", name="Pemeriksaan Penunjang Lainnya", exact=True).fill("penunjang")
    page.get_by_role("textbox", name="Hasil Pemeriksaan Penunjang").click()
    page.get_by_role("textbox", name="Hasil Pemeriksaan Penunjang").fill("penunjang 12")
    page.get_by_role("menuitem", name="Next").click()
    ...
    page.locator("#imunisasi_tgl_1").fill("2025-05-15")
    ...
    page.locator("#vit_a_1").check()
    page.get_by_role("textbox", name="Terakhir kali mendapat").fill("2025-05-15")
    ...
    page.get_by_role("textbox", name="Dosis vitamin A").fill("2")
    page.locator("#sdidtk1").check()
    page.locator("a").filter(has_text="Select Sdi Tk Bbu").click()
    page.locator("#sdi_tk_bbu_chosen").get_by_text("SK").click()
    page.locator("a").filter(has_text="Select Sdi Tk Tbu").click()
    page.locator("#sdi_tk_tbu_chosen").get_by_text("P", exact=True).click()
    ...
    page.locator("#sdt_dtk_kpsp_chosen").get_by_text("Meragukan").click()
    page.locator("a").filter(has_text="Select SDIDTK TDD").click()
    page.locator("#sdt_dtk_tdd_chosen").get_by_text("Normal").click()
    page.locator("a").filter(has_text="Select SDIDTK TDL").click()
    page.locator("#sdt_dtk_tdl_chosen").get_by_text("Normal").click()
    page.locator("a").filter(has_text="Select SDIDTK GPPH").click()
    page.locator("#sdt_dtk_gpph_chosen").get_by_text("Ragu").click()
    ...
    page.get_by_role("textbox", name="Diagnosa").fill("diagnosa sistol")
    ...
    page.get_by_role("textbox", name="Pemberian bantuan hidup dasar").fill("bantuan hidup")
    page.locator("#pembebasan_jalan_nafas1").check()
    page.locator("#pemberian_obat_cairan_chosen a").click()
    page.locator("#pemberian_obat_cairan_chosen").get_by_text("Antibiotik").click()
    ...
    page.locator("#pencegahan_suhu_tubuh_turun1").check()
    page.locator("#metode_pencegahan_suhu_tubuh_turun").click()
    page.locator("#metode_pencegahan_suhu_tubuh_turun").fill("metode turun")
    page.locator("#pemberian_imunisasi1").check()
    page.get_by_role("list").filter(has_text=re.compile(r"^$")).first.click()
    page.locator("#pencegahan_chosen").get_by_text("DPT3").click()
    page.get_by_role("textbox", name="Tanggal Pemberian").fill("2025-05-07")
    page.get_by_role("textbox", name="No Batch", exact=True).click()
    page.get_by_role("textbox", name="No Batch", exact=True).fill("2")
    page.get_by_role("textbox", name="Jenis makanan").click()
    page.get_by_role("textbox", name="Jenis makanan").fill("makanan ringan")
    page.get_by_role("textbox", name="Jumlah yang telah didapatkan").click()
    page.get_by_role("textbox", name="Jumlah yang telah didapatkan").fill("2 butir")
    page.get_by_role("textbox", name="Jumlah yang saat ini diberikan").click()
    page.get_by_role("textbox", name="Jumlah yang saat ini diberikan").fill("1 butir")
    page.get_by_role("textbox", name="Tatalaksana Lainnya").click()
    page.get_by_role("textbox", name="Tatalaksana Lainnya").fill("tatalaksana")
    page.locator("#pemberian_kie1").check()
    page.locator("#jenis_kie_chosen a").click()
    page.locator("#jenis_kie_chosen").get_by_text("Pemberian ASI").click()
    page.locator("#neonatus_rujuk1").check()
    page.get_by_role("textbox", name="Alasan dirujuk").click()
    page.get_by_role("textbox", name="Alasan dirujuk").fill("sakit ringan")
    page.get_by_role("radio", name="Puskesmas").check()
    page.locator("#kab_kota_dituju_chosen a").click()
    page.locator("#kab_kota_dituju_chosen a").click()
    page.get_by_role("textbox", name="Nama Faskes").click()
    page.get_by_role("textbox", name="Nama Faskes").fill("rs")
    page.get_by_role("textbox", name="Keterangan lainnya").click()
    page.get_by_role("textbox", name="Keterangan lainnya").fill("keterangan lain")
